...
if __name__ == '__main__':
    dl = DataLoader(mode='spo2')
    x_train, y_train, x_valid, y_valid, x_test, y_test = dl.load_mths(dwn_factor=1, time_length=10, testset_size=0.2, validset_proportion=0.15)
